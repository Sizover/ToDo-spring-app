...
На текущий момент реализовано согласно схеме предложенной в [этой статье](https://itnext.io/how-to-run-automation-scripts-in-multiple-environments-abc39d11aa20)

"url" - ссылка на главную страницу КИАП. Значение по-умолчанию: "https://test.kiap.local/"  
"mainLogin" - основная УЗ под которой осуществляется вход в КИАП и осуществляются все/основные тестовые манипуляции. Значение по-умолчанию: "a.sizov"  
"mainPassword" - пароль основной УЗ.  
"adminLogin" - УЗ администратора, предназначенная для "наведения порядка" в среде запуска тестов. Значение по-умолчанию: "autotest_admin"  
"adminPassword" - пароль УЗ администратора.  
"attachFolder" - директория в которую АТ проверяющие загрузку файлов, скачивают файлы. Значение по-умолчанию: "/home/isizov/IdeaProjects/testing-e2e/build/attachTests"  
